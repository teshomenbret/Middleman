...
mixin _$Company {
  ...
  CompanyName get name => throw _privateConstructorUsedError;
...
abstract class $CompanyCopyWith<$Res> {
  ...
  $Res call(
      {UniqueId id, CompanyName name, Description description, Logo logo});
}
...
abstract class _Company extends Company {
  const factory _Company(
      ...
      required final CompanyName name,
      required final Description description,
      required final Logo logo}) = _$_Company;
