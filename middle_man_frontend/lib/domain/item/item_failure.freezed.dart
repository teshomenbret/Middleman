...
abstract class Unexpected implements ItemFailure {
...
class _$InsufficientPermissions implements InsufficientPermissions {
  ...
  @override
  String toString() {
    return 'ItemFailure.insufficientPermissions()';
  }
...
abstract class InsufficientPermissions implements ItemFailure {
...
abstract class UnableToUpdate implements ItemFailure {
